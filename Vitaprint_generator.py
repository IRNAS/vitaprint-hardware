...
This script generates a .gcode file for bioscaffolds of square shape.
    ...
    0.  PRESTEP 1: calibrate you CNC machine so that the steps/unit and other settings are correct.
        PRESTEP 2: mix a gelatin/alginate hydrogel (10% w.t. /1% w.t.) and load it into a 5mL syringe
        PRESTEP 3: mount the syringe on the Vitaprint extruder.
        
    1. Below please find the following line and change the folder path to your working directory.
                
               LINE:    os.chdir(r'....folder path...')
                
    2. Try the default parameters with a 0.4 mm needle:
            
            FILENAME:               test_Vitaprint
            filament diameter:      0.4
            GAP SIZE:               1.6
            FEED RATE:              100
            EXTRUSION RATE:         0.06
            SIZE:                   16
            NUMBER OF LAYERS:       10
            SKIRT [y/n]:            y
                NUMBER OF SKIRTS (between 1 and 3): 2
            LAYER HEIGHT:           0.4
            
    3. Your output .gcode file should be the same as the test file found on https://github.com/symbiolab/Vitaprint_extruder/test_sample.gcode
    
    4. play around with the values above to optimize them for your material and setup
========================================================================
"""
